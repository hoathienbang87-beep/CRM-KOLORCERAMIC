  ...
  switch (ref.collection) {
    ...
    case "deals":
      return {
        ...
        completed_at: data.completedAt !== undefined ? data.completedAt : first(data.completed_at, null),
        canceled: first(data.canceled, false),
        canceled_at: data.canceledAt !== undefined ? data.canceledAt : first(data.canceled_at, null),
        note: first(data.note, null),
        is_deleted: first(data.isDeleted, data.is_deleted, false),
    ...
    case "inventoryMovements":
      return {
        ...
        product_sku: first(data.productSku, data.product_sku, data.code, null),
        product_name: first(data.productName, data.product_name, data.product, null),
        movement_type: first(data.movementType, data.movement_type, "adjustment"),
        qty: first(data.qty, 0),
        unit: first(data.unit, null),
        ref_type: first(data.refType, data.ref_type, null),
        ref_id: first(data.refId, data.ref_id, null),
        warehouse: first(data.warehouse, "main"),
        note: first(data.note, null),
        is_deleted: first(data.isDeleted, data.is_deleted, false),
        deleted_at: first(data.deletedAt, data.deleted_at, null),
        deleted_by_email: first(data.deletedByEmail, data.deleted_by_email, null),
